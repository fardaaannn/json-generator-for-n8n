...
export const translations = {
  id: {
    ...
    galleryTitle: 'Galeri workflow publik',
    galleryDesc: 'Contoh workflow pilihan, dimuat lewat format share-link (tanpa backend). Mau menambahkan punyamu? Buka PR yang menambahkan share token kamu ke gallery.json di repo.',
    galleryLoading: 'Memuat galeri\u2026',
    galleryError: 'Galeri tidak bisa dimuat. Coba lagi nanti.',
    galleryEmpty: 'Belum ada workflow di galeri.',
    galleryNodes: '{n} node',
    galleryLoadBtn: 'Muat',
    ...
    warnRepairedTitle: 'JSON diperbaiki otomatis.',
    warnRepairedBody: 'Output model terpotong dan strukturnya diperbaiki otomatis. Periksa hasilnya dengan teliti sebelum di-import \u2014 bagian akhir workflow bisa saja hilang.',
    riskTitle: 'Perlu ditinjau sebelum import:',
    riskBody: 'Node berikut mengirim data keluar atau membaca environment. Wajar untuk banyak workflow, tapi pastikan tujuannya memang yang kamu minta:',
    riskSendsData: 'Node "{node}" mengirim data ke {host}',
    riskReadsEnv: 'Node "{node}" membaca environment variable (process.env / $env)',
    riskNetCode: 'Node "{node}" berisi kode yang melakukan network call',
    riskBadge: 'tinjau',
    ...
    warnParamMissing: 'Node "{name}": parameter wajib "{param}" belum diisi',
    warnParamUnknown: 'Node "{name}": parameter "{param}" tidak dikenal untuk tipe node ini (kemungkinan dikarang model)',
    warnParamEnum: 'Node "{name}": nilai "{value}" untuk parameter "{param}" tidak valid (yang valid: {allowed})',
    warnTypeVersionHigh: 'Node "{name}": typeVersion {version} lebih tinggi dari versi yang dikenal ({max}) — kemungkinan dikarang model',
  ...
  en: {
    ...
    galleryTitle: 'Public workflow gallery',
    galleryDesc: 'Curated example workflows, loaded via the share-link format (no backend). Want yours listed? Open a PR adding your share token to gallery.json in the repo.',
    galleryLoading: 'Loading gallery\u2026',
    galleryError: 'The gallery could not be loaded. Try again later.',
    galleryEmpty: 'No workflows in the gallery yet.',
    galleryNodes: '{n} nodes',
    galleryLoadBtn: 'Load',
    ...
    warnRepairedTitle: 'JSON was auto-repaired.',
    warnRepairedBody: 'The model output was truncated and its structure was repaired automatically. Review the result carefully before importing \u2014 the end of the workflow may be missing.',
    riskTitle: 'Review before importing:',
    riskBody: 'These nodes send data out or read the environment. Normal for many workflows \u2014 just make sure the destination is what you asked for:',
    riskSendsData: 'Node "{node}" sends data to {host}',
    riskReadsEnv: 'Node "{node}" reads environment variables (process.env / $env)',
    riskNetCode: 'Node "{node}" contains code that makes network calls',
    riskBadge: 'review',
    ...
    warnParamMissing: 'Node "{name}": required parameter "{param}" is missing',
    warnParamUnknown: 'Node "{name}": parameter "{param}" is not recognized for this node type (possibly invented by the model)',
    warnParamEnum: 'Node "{name}": value "{value}" is not valid for parameter "{param}" (valid: {allowed})',
    warnTypeVersionHigh: 'Node "{name}": typeVersion {version} is higher than the known version ({max}) — possibly invented by the model',
